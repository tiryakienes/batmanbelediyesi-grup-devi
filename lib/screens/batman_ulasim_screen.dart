...
class BatmanUlasimScreen extends StatefulWidget {
  const BatmanUlasimScreen({super.key});

  @override
  State<BatmanUlasimScreen> createState() => _BatmanUlasimScreenState();
}

class _BatmanUlasimScreenState extends State<BatmanUlasimScreen> {
